...
# Makes the densities file and also stores the avgerage temperature and species number densities at a given radial index to calculate rates
...
# Make the rates file
make_rates(output_file="rates.txt", 
