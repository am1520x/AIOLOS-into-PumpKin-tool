...
class TestCalculateReactionRates:
    ...
    def test_temperature_effect_on_rates(self):
        ...
        rates_low_T = calculate_reaction_rates(
            reactions, densities, calc_rate_coeff, T=300
        )
        rates_high_T = calculate_reaction_rates(
            reactions, densities, calc_rate_coeff, T=600
        )
...
"""
        ...
        try:
            ...
            # Calculate rates
            rates = calculate_reaction_rates(
                reactions, densities, calc_rate_coeff, T=500
            )
